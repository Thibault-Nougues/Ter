...
public class RobotRicochet {
    ...
    public static int scan(int distance, int direction){
    	int action = AVANT;
    	// r�cup�ration de la direction de la t�te qui � pris la mesure
    	if(direction == AVANT){
    ...
    /**
     * M�thode qui ajoute des murs ou noMurs selon la distance mesur�.
     * Attention si on sors de l'ar�ne sinon EXCEPTION !!!
     * @param distance
     */
    ...
    public void strategie(){
    	...
    	/* aller chercher les derni�res cases */
